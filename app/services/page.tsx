...
export const metadata: Metadata = { title: "Technology & Product Capabilities", description: "Explore the product engineering, fintech, design, cloud, automation and security capabilities behind Techpsyco software.", alternates: { canonical: "/services" } };
...
const items = [
  ...
  ["Product design", "Every Techpsyco product is shaped around clarity, usability and a consistent experience across devices.", ["User research", "Interface systems", "Responsive experiences", "Accessibility"]],
